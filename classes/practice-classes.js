...
//CODE HERE
var ralphsInfo = ralph.getInfo();
var ralphsDialogue = ralph.dialogue();
var ralphsLocation = ralph.location
//////////////////PROBLEM 3////////////////////
...
class Player extends Character{
  ...
  defend(attack){
    let healthLeft = (this.healthLevel - attack);
    if(healthLeft > 0){
      return {
        attackStrength: attack,
        remainingHealth: healthLeft,
...
//CODE HERE
var aang = new Player('Aang', 'airbender', 100, 100)
var ozai = new Player('Ozai', 'firebender', 100, 0)
/*
...
//CODE HERE
var battle = ozai.defend(aang.attackLevel)
//////////////////PROBLEM 4////////////////////
...
//CODE HERE
var fireSpitter = new Hero('Fire Spitter', 'dragon', 5000, 5000)
fireSpitter.superPowers.push('spitting fire', 'flying', 'biting')

var fireSpitterAttack = fireSpitter.useSuperPower(0)